        ...
        return (
          <>
            ...
            >
              ...
              <DialogContainer className='py-4' overlayClassName='dark:bg-[radial-gradient(125%_125%_at_50%_10%,#050505_40%,#1b1b1b_100%)] bg-[radial-gradient(125%_125%_at_50%_10%,#ffffff_40%,#b1b1b1_100%)]'>
                <DialogContent
                  style={{
                    borderRadius: '24px',
                  }}
